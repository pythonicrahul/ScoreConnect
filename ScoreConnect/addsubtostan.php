<?php
    ...
    $Standard_sno = $_GET['Standard_sno'];
        ...
        <div class="container-fluid">
          <div class="container px-5" id="dashboardmain">
            <div class="row text-center">
                <b><h2>Select the name of the Subject you want to add to <?php echo $Standard["Standard"]; ?></h2></b>
                <br>
                <form action="addsubtostan_script.php" method="post">
                  <div class="form-group">
                    <select id="Subject" name="Subject" class="form-control mt-5 ml-5 mx-5 ">
                      <?php
                    ...
                    <input type="hidden" name="sno_imp" value="<?php echo $Standard_sno;?>"/>
                  </div>

...
$sec_sno = $_GET['Sno'];
$query_sec_query = "SELECT * FROm SECTION WHERE Sno='$sec_sno'";
$sec_q = mysqli_query($conn,$query_sec_query);
$section = mysqli_fetch_assoc($sec_q);
$standard_sno = $section["Standard"];
$query = "SELECT * FROM Standards WHERE Sno='$standard_sno'";

    $standard = mysqli_query($conn,$query);
    $result = mysqli_fetch_assoc($standard);
    $subjects_sno = explode(",",$result['Subjects']);
?>
        ...
        <div class="container-fluid">
          <div class="container px-5" id="dashboardmain">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"> Select Subjects of </h1>
            </div>
            <form action="assignteachscript.php" method="post">
            <div class="row">
            <input type="hidden" value="<?php echo $sec_sno ?>" name="sec_sno"/>
            <?php 

                foreach($subjects_sno as $sub_sno){
                    $query = "SELECT * FROM Subject WHERE Sno='$sub_sno'";
                    $subject_q = mysqli_query($conn,$query);
                    ...
                    echo '<div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                ...
                                <select class="px-3"name="'.$subject["Sno"].'">
            ...
            ?>
                <button type="submit" name="update_btn" class="btn w-100 btn-warning">Update</button>
            </div>
            </form>
        </div>
</div>

<?php
    ...
    $standardsno = $_POST['Standard'];
    $query = "SELECT * FROM Standards WHERE Sno='$standardsno'";
        ...
        <div class="container-fluid">
          <div class="container px-5" id="dashboardmain">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Subjects of <?php echo $result['Standard']; ?> </h1>
            </div>
            <h2 class="text-right"><a href="addsubtostan.php?Standard_sno=<?php echo $standardsno; ?>" class="btn btn-success">Add Subject To This Standard</a></h2>
            <div>

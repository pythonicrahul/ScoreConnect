            ...
            <div class="row">
              ...
              <table class="table text-dark mt-3 ">
                ...
                <?php
                  ...
                  {
                    $subject_sno = $result["Subject"];
                    $teacher_sno = $result["Teacher"];

                      $query1 = "SELECT * FROM SUBJECT WHERE Sno='$subject_sno'";
                      $query2 = "SELECT * FROM Teachers WHERE Sno='$teacher_sno'";
                      $subject_q = mysqli_query($conn,$query1);
                      $teacher_q = mysqli_query($conn,$query2);
                      $subject = mysqli_fetch_assoc($subject_q);
                      $teacher = mysqli_fetch_assoc($teacher_q);
                      echo '<tr>
                                    <td>'.$subject["Name"].'</td>  
                                    <td>'.$teacher["Name"].'</td>  
                                    <td><a href="viewteachdel.php?Sno='.$result["Sno"].'"><button class="btn btn-danger">Delete</button></a></td>
                                    </tr>
                                ';
                  }
                ?>
